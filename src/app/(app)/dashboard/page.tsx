        ...
        <div className="container mx-auto px-4 sm:px-6 space-y-6">
          ...
          <div className="bg-white/50 dark:bg-[#1c1917] rounded-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-800">
            <div className="flex justify-between items-center">
              <div>
                <h1 className="text-xl font-medium text-emerald-600 dark:text-emerald-400">Welcome back, {user.email?.split("@")[0]}</h1>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">Here{"'"}s an overview of your financial activities</p>
              </div>
            ...
            <div className="bg-white dark:bg-[#1c1917] rounded-lg p-3 border border-orange-100 dark:border-orange-900/20">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <Link href="/app/verify" className="text-xs font-medium text-emerald-600 dark:text-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-400">
                    Verify Now →
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-[#1c1917] rounded-lg p-3 border border-blue-100 dark:border-blue-900/20">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <Link href="/app/features" className="text-xs font-medium text-emerald-600 dark:text-emerald-500 hover:text-emerald-700 dark:hover:text-emerald-400">
                    Learn More →
                  </Link>
                </div>
              </div>
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-2">
            <div className="bg-white dark:bg-[#1c1917] rounded-lg p-4 sm:p-6 border border-gray-100 dark:border-gray-800">
              ...
              <div className="space-y-2">
                <Link href="/app/trade" className="flex items-center justify-between p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/app/wallet" className="flex items-center justify-between p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/app/history" className="flex items-center justify-between p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <div className="flex items-center gap-3">
                ...
                <Link href="/app/settings" className="flex items-center justify-between p-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  <div className="flex items-center gap-3">
